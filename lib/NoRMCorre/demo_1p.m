...
name = 'X:\Lab\Labmembers\Yoav Adam\Data\In Vivo\Hippocampus\IVQ32\2017-08-17_IVQ32-S2\slice1\FOV6\134107_Tread-3speed_Dilas-8V_488-OD0.0';
mov=vm(name);

%Yf = read_file(name);
Yf = single(mov(:,:,9001:11000));
[d1,d2,T] = size(Yf);
